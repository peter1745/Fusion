...
#include <Fusion/Renderer/CommandBuffer.hpp>
...
namespace FusionEditor {
	...
	public:
		...
		void BeginFrame(Fusion::CommandBuffer* InCommandList);
		void EndFrame(Fusion::CommandBuffer* InCommandList);
		void Shutdown();
	...
	private:
		...
		virtual void BeginFramePlatform(Fusion::CommandBuffer* InCommandList) = 0;
		virtual void EndFramePlatform(Fusion::CommandBuffer* InCommandList) = 0;
